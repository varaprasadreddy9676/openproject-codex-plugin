...
- Use dedicated tools first for projects, users, groups, memberships, versions, categories, work packages, relations, watchers, comments, deletes, and bulk task operations.
